...
(DEFAULT,'Вишневый сад',1,1903,'comedy','пустая аннотация'),
(DEFAULT,'На дне',2,1902,'drama','пустая аннотация'),
(DEFAULT,'Ромео и Джульетта',3,1595,'tragedy','пустая аннотация');
